			...
			while (true) {
				...
				case 1:
					...
					boolean valStatus = empservice.validate(emp,
							empVal -> empVal.getAge() >= 20 && empVal.getAge() <= 60 && empVal.getSalary() > 100
				...
				case 3:
					...
					try {
						...
						System.out.println(eid + "  " + emp.getName() + "  " + emp.getGender() + "  " + emp.getAge()
				...
				case 4:
					System.out.println("Provide Employee Id to Update");
					System.out.println("Enter Employee Id");
