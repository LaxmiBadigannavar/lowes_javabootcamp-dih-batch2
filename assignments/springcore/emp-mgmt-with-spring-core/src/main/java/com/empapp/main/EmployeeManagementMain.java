...
import com.empapp.test.Greetings;
import com.empapp.test.GreetingsConfig;

public class EmployeeManagementMain {

	public static void main(String[] args) {
		// Assemble the objects
				AbstractApplicationContext context = new AnnotationConfigApplicationContext(EmployeeMgmtConfig.class);
				...
				//EmployeeDaoImpl empimpl = (EmployeeDaoImpl)context.getBean(EmployeeDaoImpl.class);
				//EmpNotFoundException e = (EmpNotFoundException)context.getBean(EmpNotFoundException.class);
