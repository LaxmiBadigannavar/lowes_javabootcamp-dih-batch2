...
public class EmployeeJbdcMain {
	...
	public static void main(String[] args) {
		...
		case 1: 
			...
			/*
			 * case 2: System.out.println("Enter Employee id to delete:"); eid=sc.nextInt();
			 * empservice.delete(eid); System.out.println("Employee deleted sucessfully");
			 * break;
			 * 
			 * case 3:System.out.println("Provide Employee Id to Display");
			 * System.out.println("Enter Employee Id"); eid = sc.nextInt();
			 * 
			 * try{ emp=empservice.display(eid);
			 * System.out.println(eid+"  "+emp.getName()+"  "+emp.getGender()+
			 * "  "+emp.getAge()+" "+emp.getDesignation()+" "+emp.getDepartment());
			 * }catch(EmpNotFoundException e) { System.out.println("Employee Not found");
			 * System.out.println(); }
			 * 
			 * break;
			 * 
			 * case 4: System.out.println("Provide Employee Id to Update");
			 * System.out.println("Enter Employee Id"); int empId = sc.nextInt(); try {
			 * empservice.update(empId); }catch(EmpNotFoundException e) {
			 * System.out.println("Employee not found"); } break;
			 * 
			 * case 5: empservice.displayAll(); break;
			 */
